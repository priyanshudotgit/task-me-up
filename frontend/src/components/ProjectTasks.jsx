...
const ProjectTasks = ({ tasks }) => {
    ...
    const handleStatusChange = async (taskId, newStatus) => {
        try {
            ...
            await api.put(`/api/tasks/${taskId}`, {status: newStatus}, {headers: {Authorization: `Bearer ${await getToken()}`}});
    ...
    const handleDelete = async () => {
        try {
            ...
            await api.post(`/api/tasks/delete`, {taskIds: selectedTasks}, {headers: {Authorization: `Bearer ${await getToken()}`}})
